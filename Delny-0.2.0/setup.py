...
# TODO : retrieve the PY2 version of _qhullmodule.c on the original geosolver site
#        create a switch for the PY2 and the PY3 versions
...
module_qhull=Extension("delaunay._qhull",
                       ...
                       libraries=["qhull", numpy.get_include()])
