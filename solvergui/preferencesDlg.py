...
class DecompositionViewPreferences:
    ...
    def initSettings(self):
        ...
        if self.settings.dvData.treeAlignment == TreeOrientation.TOP:
            self.ui.alignTreeComboBox.setCurrentIndex(
                self.ui.alignTreeComboBox.findText("Top"))
        elif self.settings.dvData.treeAlignment == TreeOrientation.BOTTOM:
            self.ui.alignTreeComboBox.setCurrentIndex(
                self.ui.alignTreeComboBox.findText("Bottom"))
        elif self.settings.dvData.treeAlignment == TreeOrientation.RIGHT:
            self.ui.alignTreeComboBox.setCurrentIndex(
                self.ui.alignTreeComboBox.findText("Right"))
...
class SolutionViewPreferences:
    ...
    def setIcons(self):
        ...
        self.ui.svdConstraintClrButton.setIcon(
            QtGui.QIcon(self.dConstraintIcon))
    ...
    def showGrid(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("showGridChanged"),
                                  self.settings.svData.showGrid)
    ...
    def setPointColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.pointIcon,
                                             self.ui.svPointClrButton, color)
    ...
    def setFPointColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.fPointIcon,
                                             self.ui.svfPointClrButton, color)
            self.settings.svData.emit(QtCore.SIGNAL("fPointColorChanged"),
                                      color)
    ...
    def setLineColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.distanceIcon,
                                             self.ui.svDistanceClrButton, color)
    ...
    def setAngleColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.angleIcon,
                                             self.ui.svAngleClrButton, color)
    ...
    def setDistanceColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.dConstraintIcon,
                                             self.ui.svdConstraintClrButton,
                                             color)
            self.settings.svData.emit(QtCore.SIGNAL("distanceColorChanged"),
                                      color)
    ...
    def setBackgroundColor(self):
        ...
        if color.isValid():
            ...
            self.preferences.updateIconColor(self.backgroundIcon,
                                             self.ui.svBgClrButton, color)
            self.settings.svData.emit(QtCore.SIGNAL("backgroundColorChanged"),
                                      color)
    ...
    def setPointVisibility(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("pointVisChanged"),
                                  self.settings.svData.pointVisible)
    ...
    def setAngleVisibility(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("angleVisChanged"),
                                  self.settings.svData.angleVisible)
    ...
    def setFixedPointVisibility(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("fpointVisChanged"),
                                  self.settings.svData.fPointVisible)
    ...
    def setDistanceVisibility(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("distanceVisChanged"),
                                  self.settings.svData.distanceVisible)
    ...
    def setLineVisibility(self, state):
        ...
        self.settings.svData.emit(QtCore.SIGNAL("lineVisChanged"),
                                  self.settings.svData.lineVisible)
