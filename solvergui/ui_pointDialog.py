...
class Ui_PointDialog(object):
    def setupUi(self, PointDialog):
        ...
        self.label_19 = QtWidgets.QLabel(PointDialog)
        ...
        self.groupBox_8 = QtWidgets.QGroupBox(PointDialog)
        self.groupBox_8.setGeometry(QtCore.QRect(20, 80, 181, 141))
        self.groupBox_8.setObjectName("groupBox_8")

        self.gridLayout_4 = QtWidgets.QWidget(self.groupBox_8)
        self.gridLayout_4.setGeometry(QtCore.QRect(30, 20, 121, 101))
        self.gridLayout_4.setObjectName("gridLayout_4")

        self.gridlayout = QtWidgets.QGridLayout(self.gridLayout_4)
        self.gridlayout.setContentsMargins(0, 0, 0,0)
        self.gridlayout.setSpacing(6)
        self.gridlayout.setObjectName("gridlayout")

        self.label_21 = QtWidgets.QLabel(self.gridLayout_4)
        self.label_21.setObjectName("label_21")
        self.gridlayout.addWidget(self.label_21, 0, 0, 1, 1)

        self.label_22 = QtWidgets.QLabel(self.gridLayout_4)
        self.label_22.setObjectName("label_22")
        self.gridlayout.addWidget(self.label_22, 1, 0, 1, 1)

        self.label_23 = QtWidgets.QLabel(self.gridLayout_4)
        self.label_23.setObjectName("label_23")
        self.gridlayout.addWidget(self.label_23, 2, 0, 1, 1)

        self.pointCoordX_2 = QtWidgets.QDoubleSpinBox(self.gridLayout_4)
        ...
        self.pointCoordY_2 = QtWidgets.QDoubleSpinBox(self.gridLayout_4)
        ...
        self.pointCoordZ_2 = QtWidgets.QDoubleSpinBox(self.gridLayout_4)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(PointDialog)
        self.groupBox_7.setGeometry(QtCore.QRect(20,230,181,61))
        self.groupBox_7.setObjectName("groupBox_7")

        self.pointFixed_2 = QtWidgets.QCheckBox(self.groupBox_7)
        self.pointFixed_2.setGeometry(QtCore.QRect(40,20,79,22))
        self.pointFixed_2.setObjectName("pointFixed_2")

        self.horizontalLayout_6 = QtWidgets.QWidget(PointDialog)
        self.horizontalLayout_6.setGeometry(QtCore.QRect(20,40,181,31))
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")

        self.hboxlayout = QtWidgets.QHBoxLayout(self.horizontalLayout_6)
        self.hboxlayout.setContentsMargins(0, 0, 0, 0)
        self.hboxlayout.setSpacing(6)
        self.hboxlayout.setObjectName("hboxlayout")

        self.label_20 = QtWidgets.QLabel(self.horizontalLayout_6)
        ...
        spacerItem = QtWidgets.QSpacerItem(8,
                                           15,
                                           QtWidgets.QSizePolicy.Expanding,
                                           QtWidgets.QSizePolicy.Minimum)
        self.hboxlayout.addItem(spacerItem)

        self.pointName_2 = QtWidgets.QLineEdit(self.horizontalLayout_6)
    ...
    def tr(self, string):
        return QtWidgets.QApplication.translate("PointDialog",
                                                string,
                                                None)
