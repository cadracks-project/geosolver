...
class DistanceDialog(QtWidgets.QWidget):
    ...
    def update(self, objectInfo):
        ...
        self.ui.infoDPoint1Coords.setText(
        ...
        self.ui.infoDPoint2Coords.setText(
            ...
            if not self.prototypeManager.objectSelected.fixed:
                if self.prototypeManager.objectSelected.objType == ObjectType.DISTANCE_CONSTRAINT:
                    self.prototypeManager.updateConstraint(
                        self.prototypeManager.objectSelected, newDistance)
                else:
