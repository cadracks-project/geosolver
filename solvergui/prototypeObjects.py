...
class PrototypeManager(Singleton):
    """ The prototype manager handles the objects needed for the different
    viewports.
    Also it handles the connection with the geometric constraint solver,
        ...
        while not elements.isNull():
            ...
            if not element.isNull():
                ...
                if element.tagName() == "Point":
                    ...
                    raise Exception("Unable to import unkown object %s" % element.tagName())
    ...
    def setProblem(self, problem):
        ...
        for con in constraints:
                if isinstance(con, geosolver.DistanceConstraint):
                    ...
                    raise Exception("Unable to import constraint: "+str(con))
...
class AngleConstraint(Object):
    def __init__( self, name, pBegin, pMiddle, pEnd ):
        ...
        self.rotAngleMatrix = np.identity(4)
