...
class AngleDialog(QtWidgets.QWidget):
    ...
    def update(self, objectInfo):
        ...
        self.ui.infoAPoint1Coords.setText(
            "(" + str(round(objectInfo.pointBegin.position[0], 2)) + " ; " +
        ...
        self.ui.infoAPoint2Coords.setText(
            "(" + str(round(objectInfo.pointMiddle.position[0], 2)) + " ; " +
        ...
        self.ui.infoAPoint3Coords.setText(
            "(" + str(round(objectInfo.pointEnd.position[0], 2)) + " ; " +
            ...
            if angleObject.objType == ObjectType.ANGLE_CONSTRAINT:
                ...
                if pRange != [] and len(pRange.intervals) > 0:
                    for interval in pRange.intervals:
                        self.ui.parRangeList.addItem(
                            str(interval.left_value()) + " - " + str(
    ...
    def newAngle(self, newAngle):
        if self.prototypeManager.objectSelected != None:
            if self.prototypeManager.objectSelected.objType == ObjectType.ANGLE_CONSTRAINT:
                self.prototypeManager.updateConstraint(
                    self.prototypeManager.objectSelected, newAngle)
