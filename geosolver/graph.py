...
def _test():
    ...
    print("path v1-v20: %s" % g.path("v1","v20"))
    print("path v1-v1: %s" % g.path("v1","v1"))
    print("path v1-v1 in reverse graph: %s " % g.reverse().path("v1","v1"))
    print("removing v1")
    g.rem_vertex('v1')
    print("print graph")
    print(g)
    for i in g.fanin_numbers():
            print("vertices with fan-in : %i" % i)
            print(g.infan(i))
    for i in g.fanout_numbers():
            print("vertices with fan-out : %i" % i)
            print(g.outfan(i))
    ...
    print("total fan-in: %i" % tfi)
    print("total fan-out: %i" % tfo)
